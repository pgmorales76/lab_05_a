...
Write a function called sum() that takes in two numbers as arguments and then returns an array where the first element is
the sum of those numbers, and the second element is a concatenated string that EXACTLY follows this example and uses the
...
of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input into the function:
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let third_element = a + ' and ' + b + ' and ' + c + ' sum to ' + sumOfABandC + '.';
  console.log(third_element);
  // creating a string for fourth element
  let fourth_element = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplyABandC + '.';
...
is the sum of the numbers in the array, and the second element is a string that EXACTLY follows this example and uses the values that were input
into the function:
...
function sumArray(arr) { //eslint-disable-line
  ...
  // console.log('The sum of the array at [0] and [1] is: ', sum_of_array_at_0_and_1, ' The value of the array at [2] is: ', arr[2]);
  let sum_of_array_at_0_and_1_and_2 = sum(sum_of_array_at_0_and_1, arr[2])[0]; // 9
  // console.log('The sum of the array at [0] and [1] and [2] is: ', sum_of_array_at_0_and_1_and_2);
...
/////////////////////////////////////
/* Problem 5
Write a function called multiplyArray() that takes an array of numbers as its argument and returns an array whose first element is the product of
...
created. You're going to have to be resourceful to figure out how to do this. This function should handle an array containing three elements. However,
...
Write a function called multiplyAnyArray() that takes an array of numbers of any length as its argument and returns an array whose first element is
the product of those numbers, and the second element is a string that EXACTLY follows this example and concatenates a message using the arguments
that were passed into the function:

"The numbers 1,2,3,4,5 have a product of 120."

IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. To do multiplication, use your multiply() function that you've already
created. You're going to have to be resourceful to figure out how to do this. However, you may continue to use the + operator for string concatenation.
...
// Once you get the test passing, do an a-c-p cycle and synchronize the code between GitHub and your laptop. You're done! Submit the link to the
// repo following the instructions in Canvas.
